...
int main()
{
	...
	cv::Mat image= cv::imread(IMAGE_FOLDER "/waves.jpg");
	if (!image.data)
		return 0; 
	...
	cv::Mat input= cv::imread(IMAGE_FOLDER "/dog.jpg");
	cout << "waves vs dog: " << c.compare(input) << endl;

	// Read an image and compare it with reference
	input= cv::imread(IMAGE_FOLDER "/marais.jpg");
	cout << "waves vs marais: " << c.compare(input) << endl;

	// Read an image and compare it with reference
	input= cv::imread(IMAGE_FOLDER "/bear.jpg");
	cout << "waves vs bear: " << c.compare(input) << endl;

	// Read an image and compare it with reference
	input= cv::imread(IMAGE_FOLDER "/beach.jpg");
	cout << "waves vs beach: " << c.compare(input) << endl;

	// Read an image and compare it with reference
	input= cv::imread(IMAGE_FOLDER "/polar.jpg");
	cout << "waves vs polar: " << c.compare(input) << endl;

	// Read an image and compare it with reference
	input= cv::imread(IMAGE_FOLDER "/moose.jpg");
	cout << "waves vs moose: " << c.compare(input) << endl;

	// Read an image and compare it with reference
	input= cv::imread(IMAGE_FOLDER "/lake.jpg");
	cout << "waves vs lake: " << c.compare(input) << endl;

	// Read an image and compare it with reference
	input= cv::imread(IMAGE_FOLDER "/fundy.jpg");
