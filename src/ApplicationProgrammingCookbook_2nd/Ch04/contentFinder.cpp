...
{
	// Read input image
    cv::Mat image= cv::imread(IMAGE_FOLDER "/waves2.jpg",0);
	if (!image.data)
		return 0; 
	...
	// Load color image
	ColorHistogram hc;
    cv::Mat color= cv::imread(IMAGE_FOLDER "/waves2.jpg");
	...
	// Second color image
	cv::Mat color2= cv::imread(IMAGE_FOLDER "/dog.jpg");
	...
	// Second colour image
	color2= cv::imread(IMAGE_FOLDER "/dog.jpg");
