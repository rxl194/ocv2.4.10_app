...
int main()
{
	...
	// Read input image
	cv::Mat image= cv::imread(IMAGE_FOLDER "/church01.jpg",0);
	if (!image.data)
		return 0; 
   ...
   // threshold the corner strengths
	...
	// Read input image
	image= cv::imread(IMAGE_FOLDER "/church01.jpg",0);
...
//	cv::DynamicAdaptedFeatureDetector fastD(cv::FastAdjuster::create("FAST"),150,200,50);
	...
	// Read input image
	image= cv::imread(IMAGE_FOLDER "/church01.jpg",CV_LOAD_IMAGE_GRAYSCALE);
	...
	image= cv::imread(IMAGE_FOLDER "/church03.jpg",CV_LOAD_IMAGE_GRAYSCALE);
